...
/** Contains static methods for generating random sentences
  from the uni-, bi-, and tri-grams with distributed probabilities
  based on the n-grams' frequencies. N-grams came from Enron
  emails we were given in a college course.

  The Main method generates 20 random sentences six times:
  For both upspeak and downspeak (email to superior or to employee)
  and using the three n-gram methods for each*/
